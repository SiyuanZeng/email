package com.epam.preprod.firefox;

import com.epam.preprod.firefox.model.Message;
import com.epam.preprod.firefox.model.User;
...
public class TestGmail {
    ...
    static final Logger logger = LogManager.getLogger(TestGmail.class);

    protected WebDriver firefoxDriver;
    private LoginPage loginPage;
    private String URL_LOGIN_PAGE = "http://www.gmail.com/";
    private String EMAIL = "oksanatesttest@gmail.com";
    private String PASSWORD = "test2016";
    private User user;
